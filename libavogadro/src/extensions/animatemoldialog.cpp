...
namespace Avogadro {
  ...
  AnimateMolDialog::AnimateMolDialog( QWidget *parent, Qt::WindowFlags f ) : QDialog( parent, f )
  {
    //  qDebug() << "AnimateMolDialog::AnimateMolDialog()" << endl;
    ui.setupUi(this);
  ...
  AnimateMolDialog::~AnimateMolDialog()
  {
    //  qDebug() << "AnimateMolDialog::~AnimateMolDialog()" << endl;
  }

  void AnimateMolDialog::loadFile()
  {
    // Load a file
  ...
  void AnimateMolDialog::setFrame(int i)
  {
  ...
  void AnimateMolDialog::setFrameCount(int i)
  {
    m_frameCount = i;
    ui.frameSlider->setMaximum(i);
  }

  int AnimateMolDialog::fps()
  {
